...
This dataset contains information about homicide cases in `r n_cities` cities, across `r n_states` states. The following table summarizes some key facts about the ten cities with the highest number of homicide cases. I would describe the data more, but the Washington Post article has a pay-wall so I can't read it.
